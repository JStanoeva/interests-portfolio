      ...
      <header className="sticky top-0 z-50 border-b border-amber-200/60 bg-amber-50/70 backdrop-blur supports-[backdrop-filter]:bg-amber-50/50">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          <a href="#home" className="flex items-center gap-2 font-bold">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-amber-300 to-yellow-400 text-slate-900 ring-1 ring-amber-500/30">
              🧀
            </span>
